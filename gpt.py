...
for i in tqdm(dataset):
    try:
        ...
        {"role": "user", "content": "Generate a code generation problem, with its solution and Chain-ofThought. Please follow this exaxple:" + text}
            ],
            request_timeout=200,
            max_tokens=2000,
        )
...
# print(dataset)
with open("./cot/CoT-" + model + "-pass10-resume.json", "w") as f:
